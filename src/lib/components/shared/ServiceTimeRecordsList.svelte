<script lang="ts">
	...
	import ServiceTimeRecordFormModal from './ServiceTimeRecordFormModal.svelte';
	...
	let { serviceId, timeRecords, typeOptions, categoryOptions, employees, currentUserId, onTimeRecordsChange }: Props = $props();
