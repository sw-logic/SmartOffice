...
<div class="space-y-6">
	<div class="flex items-center gap-4">
		...
		<div>
			...
			<p class="text-muted-foreground">Add a new vendor or supplier</p>
		</div>
	</div>
	...
	>
		<Card.Root class="max-w-2xl">
			<Card.Header>
				...
				<Card.Description>Enter the vendor's basic details</Card.Description>
			</Card.Header>
		...
		<div class="flex gap-4 max-w-2xl">
			...
			<Button type="button" variant="outline" href="/vendors">Cancel</Button>
		</div>
	</form>
</div>
