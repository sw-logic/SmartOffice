...
<div class="space-y-6">
	<div class="flex items-center gap-4">
		...
		<div>
			<h1 class="text-3xl font-bold tracking-tight">New Employee</h1>
			<p class="text-muted-foreground">Add a new employee to your company</p>
		</div>
	</div>
	...
	>
			...
			<Card.Content class="space-y-4">
				...
				<div class="grid grid-cols-3 gap-4">
					<div class="space-y-2">
						...
						<Input id="city" name="city" placeholder="City" value={form?.values?.city || ''} />
					</div>
		...
		<Card.Root class="max-w-2xl">
			...
			<Card.Content class="space-y-4">
				...
				<div class="space-y-2">
					...
					<Input id="hireDate" name="hireDate" type="date" value={form?.values?.hireDate || ''} />
				</div>
			</Card.Content>
		</Card.Root>
		...
		<div class="flex gap-4 max-w-2xl">
			...
			<Button type="button" variant="outline" href="/employees">Cancel</Button>
		</div>
	</form>
</div>
