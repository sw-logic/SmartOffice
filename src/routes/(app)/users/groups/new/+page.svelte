<script lang="ts">
	...
	let selectedPermissions = $state<Set<string>>(new Set((form?.values?.permissionIds || []).map((id: number | string) => String(id))));
...
<div class="space-y-6">
	<div class="flex items-center gap-4">
		...
		<div>
			<h1 class="text-3xl font-bold tracking-tight">New User Group</h1>
	...
	>
		<Card.Root class="max-w-2xl">
			<Card.Header>
				...
				<Card.Description>Enter the basic information for this group</Card.Description>
			</Card.Header>
